        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Shop')" class="grid">
                ...
                <flux:navlist.item icon="shopping-cart" :href="route('cart')" :current="request()->routeIs('cart')"
                    wire:navigate>{{ __('Cart') }}</flux:navlist.item>
            </flux:navlist.group>
            <flux:navlist.group :heading="__('Platform')" class="grid">
                <flux:navlist.item icon="sparkles" href="/admin/product-recommendations"
                    :current="request()->is('admin/product-recommendations*')">
                    {{ __('Products Recommendations') }}
                </flux:navlist.item>
            </flux:navlist.group>
        </flux:navlist>
        ...
        @else
            <div class="hidden lg:block">
                <a href="{{ route('login') }}" wire:navigate>
                    <flux:button variant="primary" size="sm">Log In</flux:button>
                </a>
            </div>
        @endauth
    </flux:sidebar>
